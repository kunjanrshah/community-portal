...
class SmartFilter extends REST_Controller
{
    function index() {
        if (($this->flag) == "1") {
            ...
            $dataList = $this->Users_model->get_search_datatables("", $sWhere, $start, $length, "id", "DESC",$filterby);
            $dataListCount = $this->Users_model->get_search_datatables("", $sWhere, "", "", "id", "DESC",$filterby);
